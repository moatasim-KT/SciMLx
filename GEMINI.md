...
uv run train.py --benchmark ns_2d    --model FNO  --hidden 32 --layers 4 --modes 8  --budget 600
...
7. **2D model size**: h≤32, l≤4, m≤8, budget_s=480 (ns_2d: 600) — larger configs crash.
...
3. **Push ns_2d below SOTA** — 0.0152 vs 0.0128; try RFNO h=32 m=8 or H1 loss.
